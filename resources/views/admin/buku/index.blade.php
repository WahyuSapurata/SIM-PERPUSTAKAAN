...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            window.location.href = '/admin/manajemen-buku/add-view-buku';
        })

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            window.location.href = '/admin/manajemen-buku/edit-view-buku/' + $(this).attr('data-uuid');
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/manajemen-buku/delete-buku/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/manajemen-buku/get-buku',
                columns: [{
                        data: null,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            result =
                                `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/foto_buku/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/foto_buku/${data}')">
                                    </div>
                                    <!--end::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Buku" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        if (!groupedData[group]) {
                            ...
                            return $("<tr/>")
                                .append(
                                    ...
                                    '<span style="font-weight: bold; color: #5caceb; padding: 2px 12px; font-size: 12px; border-radius: 8px; text-transform: uppercase;"> Kategori = ' +
                                    group +
                                    '</span>' +
                                    '</td>'
