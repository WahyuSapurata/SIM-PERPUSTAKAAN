            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="uuid_anggota" class="form-control" name="uuid_anggota">
                        <small class="text-danger uuid_anggota_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">buku</label>
                        <input type="text" id="uuid_buku" class="form-control" name="uuid_buku">
                        <small class="text-danger uuid_buku_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Peminjam');
        });
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-peminjaman', 'Tambah',
                    'Data Peminjam',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-peminjaman/' + uuid,
                    'Update',
                    'Data Peminjam', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-peminjaman/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data Peminjam', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-peminjaman/' + $(this).attr('data-uuid');
            ...
            $('#kt_table_data').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Peminjam" class="btn btn-danger button-delete btn-icon btn-sm">
