...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            control.submitFormMultipartData('/admin/update-data-anggota/' + $(this).attr('data-uuid'),
                'Update',
                'Data Anggota', 'POST');
        })
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="anggota" class="btn btn-danger button-delete btn-icon btn-sm">
